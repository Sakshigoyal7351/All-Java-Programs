	...
	public static void main(String[] args) throws IOException {
		...
		Scanner sc = new Scanner (System.in);
		 ...
		 while(quit)
		 {
          ...
          int choice= sc.nextInt();
			...
			case 1:
				...
				File directory = new File("C:\\Users\\LENOVO\\Desktop\\filehandling"+filename+"txt");
         ...
         case 2:
        	 ...
        	 f2=sc.next();
				FileWriter fw = new FileWriter("C:\\Users\\LENOVO\\Desktop\\filehandling\\"+f2+".txt");
         ...
         case 3:
        	 ...
        	 try
        	 {
        		 ...
        		 File d2 = new File("C:\\Users\\LENOVO\\Desktop\\filehandling\\"+f3+".txt");
         ...
         case 4:
    		 ...
    		 File d1 = new File("C:\\Users\\LENOVO\\Desktop\\filehandling\\"+f4+"txt");
